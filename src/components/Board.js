        ...
        return (
            <div className='board__container'>
                ...
                <div className='board__button-container' >
                    <button className='board__button-addList' onClick={this.handleClick.bind(this)} style={{ display: this.state.expandForm ? 'none' : 'block' }} >Add List...</button>
                </div>
                <form
                ...
                >
                    <div className='form-container'>
                        <textarea className='form-card-description' value={this.state.listName} onChange={this.changeListTitle} onKeyPress={this.handleKeyPress} />
                        <div className='form-btn-container'>
                            <button type='submit' className='btn--add'>Add</button>
                            <button className='btn--cancel'><img src='../close-round.png' className='cancel' alt='' /></button>
                        </div>
                    </div>
                </form>
            </div>
